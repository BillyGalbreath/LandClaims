...
public class CmdChildClaims implements TabExecutor {
    private final LandClaims plugin;

    public CmdChildClaims(LandClaims plugin) {
        this.plugin = plugin;
    }
    ...
    public boolean onCommand(CommandSender sender, Command command, String label, String[] args) {
        ...
        if (!sender.hasPermission("command.childclaims")) {
