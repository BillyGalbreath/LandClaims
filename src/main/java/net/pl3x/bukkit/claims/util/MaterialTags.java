...
public class MaterialTags {
    ...
    //.ensureSize("COLORABLE", 7);

    public static final MaterialSetTag DOORS = new MaterialSetTag()
            .endsWith("_DOOR").endsWith("_TRAPDOOR").endsWith("_FENCE_GATE");

    public static final MaterialSetTag BUTTONS = new MaterialSetTag()
    ...
    public static final MaterialSetTag BOATS = new MaterialSetTag()
            .endsWith("_BOAT");

    public static final MaterialSetTag MINECARTS = new MaterialSetTag()
            .add(Material.MINECART).endsWith("_MINECART");

    public static final MaterialSetTag INTERACTABLE = new MaterialSetTag()
    ...
    public static final MaterialSetTag PORTAL = new MaterialSetTag()
            .endsWith("_PORTAL");
}
